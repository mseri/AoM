...
% TODO: properly explain how the change of variable in Euclidean space requires the absolute value of the Jacobian determinant, and thus in our definition we need to take into account the orientation and compensate with a minus sign if necessary.
