...
\begin{exercise}
  ...
  Show that the integral curves of $X$ are the straight lines parallel to the $x$-axis, with parametrizations of the form $\gamma(t) = \alpha t + \beta$ for some constants $\alpha, \beta \in\R$.
\end{exercise}
...
Note that $I_p$ is typically larger than the domain of definition $(-\epsilon, \epsilon)$ of $\Phi_p$. By construction $\Phi_p$ never leaves the coordinate set $U$ over which it was defined, on the other hand $\gamma_p$ can in general wander all over the manifold -- even though $\gamma_p = \Phi_p$ for values of $t$ small enough!
