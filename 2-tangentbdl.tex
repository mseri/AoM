...
\begin{rmk}[Change of coordinates]\label{rmk:chg_coords}
...
\begin{thm}[The chain rule on manifolds]\label{thm:chainrule_mfld}
...
\begin{exe}\label{ex:tg_curve_iso}
...
\begin{thm}[Inverse function theorem]\label{thm:ift}
...
\begin{thm}[Inverse function theorem for manifolds]\label{thm:iftm}
...
\begin{prop}\label{prop:slice_chart}
...
\begin{thm}[Implicit function theorem for manifolds]\label{thm:impl_fun}
...
\begin{prop}\label{prop:submanifolds_and_R}
