...
\begin{exercise}
  Show that the differential of a smooth map is a smooth map between manifolds.\textit{\small Hint: use the natural differentiable structure on the tangent bundle described above and the definition of smooth map.}
\end{exercise}
