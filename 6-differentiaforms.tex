...
\begin{equation}
  \bigwedge_{k=1}^{2n} \alpha^k = \frac{(-1)^{\binom{n}{2}}}{n!} \LaTeXunderbrace{\omega\wedge\cdots\wedge\omega}_{n\mbox{ times}}.
\end{equation}
\end{exercise}
...
\begin{exercise}
  ...
  \begin{enumerate}
    ...
    \textit{\small Hint: compare Exercise~\ref{exe:FTC}.3 and Examples~\ref{ex:li}.}
  \end{enumerate}
\end{exercise}
...
\begin{corollary}\ref{cor:deRhamIso}
