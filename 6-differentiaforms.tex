...
\begin{example}[Exterior derivatives and vector calculus in $\R^3$]
  ...
  In a similar fashion, we can also define a smooth bundle isomorphism $\star: C^\infty(\R^3) \to \Omega^3(\R^3)$ via
  \begin{equation}
    \star(f) = f dx\wedge dy\wedge dz.
  \end{equation}
