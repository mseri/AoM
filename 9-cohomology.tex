...
\begin{definition}\idxdef{de Rham cohomology}\idxdef{de Rham cohomology}
...
\begin{theorem}\idxthm{Poincar\'e lemma}
...
\begin{definition}\idxdef{Homotopy (equivalence)}
...
\begin{theorem}\label{thm:deRham-invariance}\idxthm{de Rham homotopy invariance}
...
\begin{definition}\idxdef{Contractible space}
...
\begin{corollary}[Poincar\'e lemma]\label{cor:plemma}\idxthm{Poincar\'e lemma}
