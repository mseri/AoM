...
in place of
\begin{quote}
  Let $pxin M$ and $(U, \phi)$ a chart defined on a neighborhood $U$ of $x$. Let $x^i = r^i \circ\phi$ denote the components of $\phi$ with respect to the standard euclidean coordinates...
\end{quote}
