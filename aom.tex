...
The book~\cite{book:nicolaescu}, freely available from the author website, is bit really suitable as a reference but provides a fantastic resource if you want to dig further and see where the material discussed in the course can lead you.
...
\begin{equation}
  \sum_{i} a^i \frac{\partial}{\partial x^i} \equiv a^i \frac{\partial}{\partial x^i}.
\end{equation}
