...
\ifx\ifxetex\ifluatex\else % if lua- or xelatex http://tex.stackexchange.com/a/140164/1913
  \usepackage{fontspec}
  % Path=. is needed for the github action to automatically build the OD version
  \setmainfont[Path=.]{OpenDyslexic}
  \setsansfont[Path=.]{OpenDyslexic}
  \setmonofont[Path=.]{OpenDyslexicMono}
