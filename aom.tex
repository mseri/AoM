...
Many thanks also to Huub Bouwkamp, Bram Brongers, Mollie Jagoe Brown, Luuk de Ridder, Jordan van Ekelenburg and Dave Verweg for reporting a number of misprints and corrections.
...
\chapter{TODO}
\begin{itemize}
  \item Add proof of fixed point thm using Stokes
  ...
  \item Add exercise on Liouville theorem for hamiltonians in symplectic geometry
  \item Add exercise on fixed-points for gradient flows and Hamiltonian flows
  \item More computational exercises
\end{itemize}
