...
\begin{ex}
  ...
  \end{equation}
  is \emph{not} a topological manifold of dimension $n$. Can you see why? In fact, this is an example of a more general concept of \emph{manifold with boundary} that we will introduce later in Chapter \todo{add ref}.
\end{ex}
...
If $f:M_1\to M_2$ between two smooth manifolds is a $C^p$-diffeomorphism for all $p$, then we say that $f$ is a \emph{diffeomorphism}.
