...
\addQEDstyle{exercise}{$(\bigstar)let$}
\newtheorem{problem}[theorem]{Problem}
\addQEDstyle{problem}{$(\bigstar)let$}
...
Many thanks also to Luuk de Ridder for reporting a number of misprints.
